...
<html>
 <head>
    ...
    <tr>
        <td><b>on/off Status</b></td>
        <td><b>power on/off</b></td>
        <td><b>enable/disable</b></td>
    </tr>
    <tr>
    ...
    <tr>
    	<td>
    		<canvas id="power1" width="300" height="300">[No canvas support]</canvas>
    	</td>
    	<td>
    		<canvas id="power2" width="300" height="300">[No canvas support]</canvas>
    	</td>
    	<td>
    		<canvas id="power3" width="300" height="300">[No canvas support]</canvas>
    	</td>
...
<script>
    ...
    // current power gauge
    var p1=<?php print $oldstatus["gpower1"];?>;
    var gauge1 = new RGraph.Gauge('power1', 0,<?php print $eis_dev_conf["gpower1"];?>, p1);
    gauge1.Set('chart.red.start','3000');
    gauge1.Set('chart.green.end','1000');
    gauge1.Set('chart.green.color','red');
    gauge1.Set('chart.red.color','green');
    RGraph.Effects.Gauge.Grow(gauge1);
    
     // current power gauge
    var p1=<?php print $oldstatus["gpower2"];?>;
    var gauge2 = new RGraph.Gauge('power2', 0,<?php print $eis_dev_conf["gpower2"];?>, p1);
    gauge2.Set('chart.red.start','3000');
    gauge2.Set('chart.green.end','1000');
    gauge2.Set('chart.green.color','red');
    gauge2.Set('chart.red.color','green');
    RGraph.Effects.Gauge.Grow(gauge2);

	 // current power gauge
    var p1=<?php print $oldstatus["gpower3"];?>;
    var gauge3 = new RGraph.Gauge('power3', 0,<?php print $eis_dev_conf["gpower3"];?>, p1);
    gauge3.Set('chart.red.start','3000');
    gauge3.Set('chart.green.end','1000');
    gauge3.Set('chart.green.color','red');
    gauge3.Set('chart.red.color','green');
