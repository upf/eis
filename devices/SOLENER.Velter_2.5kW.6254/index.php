...
<html>
 <head>
    ...
    <tr>
        <td><canvas id="power" width="300" height="300">[No canvas support]</canvas></td>
...
<script>
    ...
    var gauge1 = new RGraph.Gauge('power', 0,<?php print $eis_dev_conf["gpower1"];?>, p1);
    gauge1.Set('chart.red.start','1200');
    gauge1.Set('chart.green.end','500');
